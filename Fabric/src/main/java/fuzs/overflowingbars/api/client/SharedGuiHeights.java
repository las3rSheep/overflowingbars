...
public class SharedGuiHeights {
     ...
     * <p>Example usage:
     * <pre>{@code
     * Optional<MutableInt> leftHeight = FabricLoader.getInstance().getObjectShare().get("overflowingbars:leftHeight") instanceof MutableInt height ? Optional.of(height) : Optional.empty();
     ...
     * <p>Example usage:
     * <pre>{@code
     * Optional<MutableInt> rightHeight = FabricLoader.getInstance().getObjectShare().get("overflowingbars:rightHeight") instanceof MutableInt height ? Optional.of(height) : Optional.empty();
