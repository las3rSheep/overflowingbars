package fuzs.overflowingbars.forge.client;

import fuzs.overflowingbars.OverflowingBars;
import fuzs.overflowingbars.client.OverflowingBarsClient;
import fuzs.overflowingbars.forge.client.handler.ForgeGuiOverlayHandler;
...
public class OverflowingBarsForgeClient {
    ...
    private static void registerHandlers() {
        MinecraftForge.EVENT_BUS.addListener(ForgeGuiOverlayHandler::onBeforeRenderGuiOverlay);
    }

    @SubscribeEvent
    public static void onRegisterGuiOverlays(final RegisterGuiOverlaysEvent evt) {
        evt.registerAbove(VanillaGuiOverlay.MOUNT_HEALTH.id(), "toughness_level", ForgeGuiOverlayHandler.TOUGHNESS_LEVEL);
    }
}
