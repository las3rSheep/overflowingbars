package fuzs.overflowingbars.forge.client.handler;
...
public class ForgeGuiOverlayHandler {
    public static final IGuiOverlay TOUGHNESS_LEVEL = (ForgeGui gui, GuiGraphics guiGraphics, float partialTick, int screenWidth, int screenHeight) -> {
